...
{
    class MC : IProcessable
    {
        private Simul _simulationEngine;
        private Random _random;
        private int _currentMCIteration;

        public MC(Random random, Simul simulationEngine)
        {
            _random = random;
        ...
        public void NextStep()
        {
            ...
            do
            {
                ...
                CoordinateMonteCarlo(postitionToRandom[randIndex].X, postitionToRandom[randIndex].Y);
        ...
        private void CoordinateMonteCarlo(int x, int y)
        {
