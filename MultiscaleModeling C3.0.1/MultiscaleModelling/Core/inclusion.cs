...
namespace MultiscaleModelling.Core
{
    class InclusionsEngine
    {
        ...
        public InclusionsEngine(Random random, Simul simulationEngine)
        {
            _random = random;
        ...
        private void GrowCircleInclusion(Pix seed, int size)
        {
        ...
        private void GrowSquareInclusion(Pix seed, int size)
        {
        ...
        private Pix GetSeedForInclusion()
        {
        ...
        private Pix GetSeedForInclusionAfter()
        {
        ...
        private Pix GetSeedForInclusionBefore()
        {
            int x, y;
